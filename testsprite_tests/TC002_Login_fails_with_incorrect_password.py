...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Iniciar Sesión' link to navigate to the login page and reveal the login form.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/header/div/div/a[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Fill the email and password fields with the provided incorrect credentials and submit the form to verify the authentication error message is shown.
        frame = context.pages[-1]
        # Input text
