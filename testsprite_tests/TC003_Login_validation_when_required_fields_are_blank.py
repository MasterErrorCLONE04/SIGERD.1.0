...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with instructor1@sigerd.com, clear the password field (leave empty), submit the form to trigger validation errors for the missing password.
        frame = context.pages[-1]
        # Input text
