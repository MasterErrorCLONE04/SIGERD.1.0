...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with instructor1@sigerd.com, fill the password with password, and submit the login form.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the "Ver Todos mis Reportes" link to open the instructor incidents page and then verify the incidents list is displayed.
        frame = context.pages[-1]
        # Click element
