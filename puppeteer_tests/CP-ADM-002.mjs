...
async function runTest() {
    ...
    let result = {
        ...
        resultado_esperado: 'Mensaje de error de credenciales ("These credentials do not match our records."). No ingresa.',
        resultado_obtenido: "",
        capturas: {
    ...
    try {
        ...
        if (url.includes('/login') && hasErrorElement) {
            ...
            result.resultado_obtenido = "Sistema permaneció en login y mostró mensaje de error de credenciales válido.";
        } else if (url.includes('/dashboard')) {
            result.estado = "Fallido";
            result.resultado_obtenido = "Peligro de Seguridad: El sistema permitió el acceso con clave errónea.";
        } else {
            result.estado = "Fallido";
