                    ...
                    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                        <div class="flex items-center space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-14 h-14 bg-white/20 backdrop-blur-lg rounded-xl flex items-center justify-center shadow-lg ring-2 ring-white/30">
                            ...
                            <div>
                                <h3 class="text-2xl lg:text-3xl font-bold text-white">{{ __("¡Bienvenido, ") }}{{ Auth::user()->name }}!</h3>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 rounded-xl p-6 shadow-lg">
                    <div class="flex flex-col lg:flex-row gap-6 items-center">
                        ...
                        <div class="flex-1 space-y-4">
                            <div>
                                <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 flex items-center gap-2">
                                ...
                                <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Este gráfico muestra la distribución actual de todas las tareas según su estado en el sistema. Te permite visualizar rápidamente cuántas tareas están asignadas, en progreso, realizadas, finalizadas o incompletas, facilitando la gestión y priorización del trabajo.
                                </p>
                            </div>
                            <!-- Stats Mini -->
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                                    <div class="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Asignadas</div>
                                    <div class="text-lg font-bold text-blue-700 dark:text-blue-300">{{ $tasksByStatus['asignado'] ?? 0 }}</div>
                                </div>
                                <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-3 border border-yellow-200 dark:border-yellow-800">
                                    <div class="text-xs text-yellow-600 dark:text-yellow-400 font-medium mb-1">En Progreso</div>
                                    <div class="text-lg font-bold text-yellow-700 dark:text-yellow-300">{{ $tasksByStatus['en progreso'] ?? 0 }}</div>
                                </div>
                                <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border border-green-200 dark:border-green-800">
                                    <div class="text-xs text-green-600 dark:text-green-400 font-medium mb-1">Finalizadas</div>
                                    <div class="text-lg font-bold text-green-700 dark:text-green-300">{{ $tasksByStatus['finalizada'] ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-6 items-center">
                        ...
                        <div class="flex-1 space-y-4">
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Visualiza la composición de tu equipo según los roles asignados. Este gráfico te ayuda a entender la distribución de administradores, instructores y trabajadores en el sistema, permitiéndote balancear las responsabilidades y recursos del equipo.
                                </p>
                            </div>
                            <!-- Stats Mini -->
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                <div class="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-3 border border-indigo-200 dark:border-indigo-800">
                                    <div class="text-xs text-indigo-600 dark:text-indigo-400 font-medium mb-1">Administradores</div>
                                    <div class="text-lg font-bold text-indigo-700 dark:text-indigo-300">{{ $usersByRole['administrador'] ?? 0 }}</div>
                                </div>
                                <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3 border border-purple-200 dark:border-purple-800">
                                    <div class="text-xs text-purple-600 dark:text-purple-400 font-medium mb-1">Instructores</div>
                                    <div class="text-lg font-bold text-purple-700 dark:text-purple-300">{{ $usersByRole['instructor'] ?? 0 }}</div>
                                </div>
                                <div class="bg-pink-50 dark:bg-pink-900/20 rounded-lg p-3 border border-pink-200 dark:border-pink-800">
                                    <div class="text-xs text-pink-600 dark:text-pink-400 font-medium mb-1">Trabajadores</div>
                                    <div class="text-lg font-bold text-pink-700 dark:text-pink-300">{{ $usersByRole['trabajador'] ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-6 items-center">
                        ...
                        <div class="flex-1 space-y-4">
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Monitorea la distribución de tareas según su nivel de urgencia. Este análisis te permite identificar si hay un exceso de tareas de alta prioridad que requieren atención inmediata, o si el trabajo está bien equilibrado entre las diferentes prioridades.
                                </p>
                            </div>
                            <!-- Stats Mini -->
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-3 border border-red-200 dark:border-red-800">
                                    ...
                                    <div class="text-lg font-bold text-red-700 dark:text-red-300">{{ $tasksByPriority['alta'] ?? 0 }}</div>
                                </div>
                                <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-3 border border-yellow-200 dark:border-yellow-800">
                                    <div class="text-xs text-yellow-600 dark:text-yellow-400 font-medium mb-1">Media</div>
                                    <div class="text-lg font-bold text-yellow-700 dark:text-yellow-300">{{ $tasksByPriority['media'] ?? 0 }}</div>
                                </div>
                                <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border border-green-200 dark:border-green-800">
                                    <div class="text-xs text-green-600 dark:text-green-400 font-medium mb-1">Baja</div>
                                    <div class="text-lg font-bold text-green-700 dark:text-green-300">{{ $tasksByPriority['baja'] ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-6 items-center">
                        ...
                        <div class="flex-1 space-y-4">
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-400 leading-relaxed">
                                    Rastrea el flujo de trabajo de los incidentes reportados. Desde los que están pendientes de revisión, pasando por los asignados, hasta los resueltos. Este gráfico te ayuda a identificar cuellos de botella y garantizar que ningún incidente quede sin atender.
                                </p>
                            </div>
                            <!-- Stats Mini -->
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-3 border border-yellow-200 dark:border-yellow-800">
                                    <div class="text-xs text-yellow-600 dark:text-yellow-400 font-medium mb-1">Pendientes</div>
                                    <div class="text-lg font-bold text-yellow-700 dark:text-yellow-300">{{ $incidentsByStatus['pendiente de revisión'] ?? 0 }}</div>
                                </div>
                                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                                    <div class="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Asignados</div>
                                    <div class="text-lg font-bold text-blue-700 dark:text-blue-300">{{ $incidentsByStatus['asignado'] ?? 0 }}</div>
                                </div>
                                <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border border-green-200 dark:border-green-800">
                                    <div class="text-xs text-green-600 dark:text-green-400 font-medium mb-1">Resueltos</div>
                                    <div class="text-lg font-bold text-green-700 dark:text-green-300">{{ $incidentsByStatus['resuelto'] ?? 0 }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
