            ...
            @push('scripts')
                ...
                <script type="text/javascript">
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        const usersByRoleLabels = ['Administradores', 'Instructores', 'Trabajadores'];
                        ...
                        const userRoleColors = {
                            'Administradores': '#4F46E5', // indigo-500
                            'Instructores': '#9333EA', // purple-500
                            'Trabajadores': '#EC4899', // pink-500
                        };
