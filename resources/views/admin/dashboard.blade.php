<x-app-layout>
    ...
    <div class="py-8 bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-slate-900 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Welcome Section -->
            <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-white/20 dark:border-gray-700/30 overflow-hidden shadow-lg rounded-2xl mb-8">
                <div class="p-8">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mt-1">Aquí tienes un resumen completo de la actividad de tu plataforma.</p>
                        </div>
                    </div>
                </div>
            </div>
