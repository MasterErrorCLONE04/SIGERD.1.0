                    ...
                    <form method="POST" action="{{ route('admin.tasks.update', $task->id) }}"
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 bg-white dark:bg-[#242526] dark:bg-gray-900 text-gray-700 dark:text-gray-200 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('description', $task->description) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="deadline_at" class="block mt-1 w-full" type="date" name="deadline_at"
                                :value="old('deadline_at', $task->deadline_at ? $task->deadline_at->format('Y-m-d') : '')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="location" class="block mt-1 w-full" type="text" name="location"
                                :value="old('location', $task->location)" required />
                        ...
                        @if ($task->reference_images && count($task->reference_images) > 0)
                            <div class="mt-4">
                                <p class="text-lg font-semibold text-gray-800 dark:text-gray-100 dark:text-gray-200 mb-3">
                                    Imágenes de Referencia Actuales:</p>
                                <div class="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4 mt-2">
                                    @foreach ($task->reference_images as $imagePath)
                                        <div class="relative group cursor-pointer overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]"
                                            ...
                                            <img src="{{ asset('storage/' . $imagePath) }}" alt="Imagen de Referencia"
                                            ...
                                            <div class="absolute top-3 right-3">
                                                <span
                                                    class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-purple-500 text-white shadow-lg">
                                                    Referencia
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input id="reference_images"
                                class="block mt-1 w-full text-sm text-gray-900 dark:text-gray-100 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                type="file" name="reference_images[]" accept="image/*" multiple />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="priority" name="priority"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 bg-white dark:bg-[#242526] dark:bg-gray-900 text-gray-700 dark:text-gray-200 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
