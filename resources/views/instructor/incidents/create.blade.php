    ...
    <div class="py-8 bg-gradient-to-br from-gray-50 via-rose-50 to-pink-50 dark:from-gray-900 dark:via-gray-900 dark:to-slate-900 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 overflow-hidden">
                <div class="p-8">
                    <div class="mb-6">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-white mb-2">Información del Reporte</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-400">Completa todos los campos para reportar una nueva falla en el sistema.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('instructor.incidents.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-[#B0B3B8] dark:text-gray-400 mt-1 mb-2">Proporciona un título descriptivo y claro para la falla</p>
                            <x-text-input id="title" 
                                          class="block mt-1 w-full rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 dark:text-gray-200 focus:ring-2 focus:ring-rose-500 dark:focus:ring-rose-400" 
                                          type="text" 
                                          name="title" 
                                          :value="old('title')" 
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-[#B0B3B8] dark:text-gray-400 mt-1 mb-2">Describe en detalle qué falla observaste, cuándo ocurrió y cualquier información relevante</p>
                            <textarea id="description" 
                                      name="description" 
                                      rows="5"
                                      class="block mt-1 w-full rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-200 dark:text-gray-300 focus:border-rose-500 dark:focus:border-rose-600 focus:ring-rose-500 dark:focus:ring-rose-600 shadow-sm" 
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-[#B0B3B8] dark:text-gray-400 mt-1 mb-2">Especifica dónde se encuentra la falla</p>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-[#B0B3B8] dark:text-gray-400 mt-1 mb-2">Selecciona la fecha en que ocurrió o detectaste la falla</p>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-[#B0B3B8] dark:text-gray-400 mt-1 mb-2">Sube imágenes que muestren el estado inicial o evidencia del daño. Al menos una imagen es obligatoria.</p>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200 dark:border-[#3A3B3C] dark:border-gray-700">
