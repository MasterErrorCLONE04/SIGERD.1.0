<x-app-layout>
    ...
    <div
        class="py-8 bg-gradient-to-br from-gray-50 via-rose-50 to-pink-50 dark:from-gray-900 dark:via-gray-900 dark:to-slate-900 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 overflow-hidden">
                <div class="p-8">
                    <div class="mb-6">
                    ...
                    <form method="POST" action="{{ route('instructor.incidents.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <x-text-input id="report_date"
                                class="block mt-1 w-full rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 dark:text-gray-200 focus:ring-2 focus:ring-rose-500 dark:focus:ring-rose-400"
                                type="date" name="report_date" :value="old('report_date', date('Y-m-d'))" required
                                max="{{ date('Y-m-d') }}" />
