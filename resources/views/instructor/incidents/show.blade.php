                ...
                <div class="p-8">
                            ...
                            <div class="flex items-center gap-3 flex-wrap">
                                @php
                                    $statusColors = [
                                        ...
                                        'resuelto' => 'bg-indigo-100 text-indigo-800 dark:bg-indigo-500/20 dark:text-indigo-300 border-indigo-300 dark:border-indigo-700',
                                        'cerrado' => 'bg-green-100 text-green-800 dark:bg-green-500/20 dark:text-green-300 border-green-300 dark:border-green-700',
                                    ];
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                            ...
                            <p class="text-gray-900 dark:text-white font-medium">{{ $incident->location ?? 'No especificada' }}</p>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                            ...
                            <p class="text-gray-900 dark:text-white font-medium">{{ $incident->created_at->format('d/m/Y H:i') }}</p>
                        </div>
