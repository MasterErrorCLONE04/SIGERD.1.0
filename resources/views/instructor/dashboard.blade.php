            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Total de Reportes</p>
                            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $totalIncidents }}</p>
                        </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $assignedIncidents }}</p>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        @empty
                            <p class="text-gray-500 dark:text-gray-400 text-center py-8">No tienes reportes pendientes de revisión</p>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/50 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        @empty
                            <p class="text-gray-500 dark:text-gray-400 text-center py-8">No tienes reportes recientes</p>
                        @endforelse
                    </div>
                </div>
            </div>
