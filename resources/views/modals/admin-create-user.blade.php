...
<div id="createUserModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
        ...
        <div
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}" enctype="multipart/form-data"
                    ...
                    @if ($errors->any() && !old('_method') && old('role'))
                            ...
                            <div class="flex-1">
                                <div class="relative">
                                    <input type="file" id="profile_photo" name="profile_photo" accept="image/*" required
                                        class="sr-only" onchange="previewUserImage(this)">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            <label for="password"
                                class="block text-sm font-bold text-gray-700 dark:text-gray-200 dark:text-gray-300">Contraseña
                                *</label>
