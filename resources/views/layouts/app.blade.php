                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div x-data="notificationDropdown()" x-init="init()" class="relative">
                                    <button @click="open = !open" class="relative p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition">
                                    ...
                                    <div x-show="open" 
                                        ...
                                        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                                            ...
                                            <button @click="markAllAsRead()" class="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                                                ...
                                                <div @click="markAsRead(notification.id, notification.link)" 
                                                    ...
                                                    <div class="flex items-start gap-3">
                                                        <div class="flex-shrink-0">
                                                            <div :class="getIconColor(notification.type)" class="w-10 h-10 rounded-lg flex items-center justify-center">
                                                                <svg x-html="getIcon(notification.type)" class="w-5 h-5"></svg>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <span x-show="!notification.read" class="w-2 h-2 bg-blue-500 rounded-full block"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </template>
                                ...
                                <div x-data="{ userMenuOpen: false }" class="relative">
                                    <button @click="userMenuOpen = !userMenuOpen" 
                                        ...
                                        <div class="text-right">
                                            <p class="text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white transition">{{ Auth::user()->name }}</p>
                                        ...
                                        @else
                                            <div class="w-10 h-10 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-lg flex items-center justify-center text-white font-bold ring-2 ring-transparent group-hover:ring-blue-500 transition">
                                    ...
                                    <div x-show="userMenuOpen" 
                                        ...
                                        {{-- User Info Header --}}
                                        <div class="px-4 py-3 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700">
                                            <div class="flex items-center gap-3">
                                                @if (Auth::user()->profile_photo)
                                                    <img src="{{ asset('storage/' . Auth::user()->profile_photo) }}" 
                                                         alt="{{ Auth::user()->name }}" 
                                                ...
                                                @else
                                                    <div class="w-12 h-12 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-lg flex items-center justify-center text-white font-bold text-lg">
                                                        {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                                                    </div>
                                                @endif
                                                <div class="flex-1 min-w-0">
                                            ...
                                            <a href="{{ route('profile.edit') }}" 
                                               class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">Preferencias de cuenta</p>
                                                </div>
                                            </a>
                                            ...
                                            <form method="POST" action="{{ route('logout') }}">
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <div class="text-left">
                                                        ...
                                                        <p class="text-xs text-red-500 dark:text-red-400">Salir de tu cuenta</p>
                                                    </div>
                                                </button>
                                            </form>
                                        </div>
