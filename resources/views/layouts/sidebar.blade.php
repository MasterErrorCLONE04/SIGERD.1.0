...
<div x-data="{ sidebarOpen: true, sidebarCollapsed: false }" class="relative">
    ...
    <aside x-show="sidebarOpen"
        ...
        {{-- Header del Sidebar --}}
        <div class="flex items-center justify-between h-16 px-4 bg-white/60 backdrop-blur-sm border-b border-indigo-200">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                <button @click="sidebarOpen = false" class="lg:hidden p-2 rounded-lg hover:bg-indigo-100 text-gray-600 hover:text-indigo-600 transition-all duration-200">
        ...
        <div class="px-4 py-4 border-b border-indigo-200 bg-white/40 backdrop-blur-sm">
            <div class="flex items-center gap-3" :class="sidebarCollapsed ? 'justify-center' : ''">
                <div class="relative flex-shrink-0">
                    ...
                    @else
                        <div class="w-12 h-12 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-xl flex items-center justify-center text-white font-bold text-lg ring-2 ring-indigo-500/50">
                ...
                <div x-show="!sidebarCollapsed" x-transition class="flex-1 min-w-0">
                    ...
                    @endphp
                    <span class="inline-flex items-center px-2 py-0.5 text-xs font-medium rounded border {{ $roleColor }}">
    ...
    <button @click="sidebarOpen = true; sidebarCollapsed = false"
            x-show="!sidebarOpen"
            x-transition
